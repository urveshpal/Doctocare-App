...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{{url('AdminDashboard/assets/css/material-dashboard.css?v=3.0.2')}}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('AdminDashboard/pages/dashboard.html')}}">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/tables.html">
            ...
            <span class="nav-link-text ms-1">Doctor Tables</span>
          </a>
        </li>
        <li class="nav-item">
